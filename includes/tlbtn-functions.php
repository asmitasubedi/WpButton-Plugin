...
function custombutton_shortcode($atts){
    ...
    $output = '';
    $output .= '<button type="button" class="custom-buttons" data-class="tlbtn_'.$btn_data->id.'" data-title="'.$btn_data->btn_name.'" data-request-url="'.$button_target_url.'" data-price="'.$btn_data->btn_price.'">'.$btn_data->btn_text.'</button>';
