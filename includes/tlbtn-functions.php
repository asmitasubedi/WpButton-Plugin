...
function custombutton_shortcode($atts){
    ...
    $output = '';
    $output .= '<a class="tlbtn-view-a" style="text-decoration:none;" href="#tlBtn-openModal"><button type="button" class="tlbtn-view-btn" data-class="tlbtn_'.$btn_data->id.'" data-title="'.$btn_data->btn_name.'" data-request-url="'.$button_target_url.'" data-price="'.$btn_data->btn_price.'">'.
        '<span style="margin-right: -15px;">'. $btn_data->btn_text. '</span>' . '</button></a>';
